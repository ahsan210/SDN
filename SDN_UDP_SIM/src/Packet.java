...
public class Packet {
	...
	private double arrival_time_switch = 0;
	private double arrival_time_controller = 0;
    private double arrival_second_time_switch = 0;
    
    private double departure_time_switch = 0;
    private double departure_time_controller = 0;
    private double departure_second_time_switch = 0;
    ...
    public double Total_data_delay(){
    	...
    	if(ControllerVisited){
    		
    		set_wait_time_switch();
        	set_wait_time_controller();
        	set_wait_second_time_switch();
        	double delay = wait_time_switch + wait_time_controller + wait_second_time_switch + 2.0* (1.0/SDNUDP.DSC);
        	return delay;
    	}else{
    ...
    public double Total_SYN_delay(){
    	...
    	set_wait_time_controller();
    	set_wait_second_time_switch();
    	double syn_delay = wait_time_switch + wait_time_controller + wait_second_time_switch + 2.0* (1.0/SDNUDP.DSC);
    	return syn_delay;
    }
